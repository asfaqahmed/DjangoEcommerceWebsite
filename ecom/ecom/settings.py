...
SECRET_KEY = 'ap3d$-*a64h%*qc$#lz*7^)vpol*q0yrs%k@h7o545qlc2sfe@'
...
PAYTM_COMPANY_NAME = "Bakeology"   # For representation purposes 
PAYTM_INDUSTRY_TYPE_ID = "Retail"     # For staging environment
PAYTM_CHANNEL_ID = "WEB"
PAYTM_MERCHANT_KEY = "Your_MERCHANT_KEY"
PAYTM_MERCHANT_ID = "Your_MERCHANT_ID"
PAYTM_CALLBACK_URL = "http://127.0.0.1:8000/makePaymentresponse/" # Hardcode
